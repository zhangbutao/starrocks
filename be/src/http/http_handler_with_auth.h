...
public:
    HttpHandlerWithAuth(ExecEnv* exec_env, TPrivilegeObject::type object, TPrivilegeType::type type);
    ...
    virtual bool on_privilege(const HttpRequest& req, TCheckAuthRequest& auth_request) {
        TPrivilegeControl priv_ctrl;
        priv_ctrl.priv_object = _object;
        auth_request.__set_priv_control(priv_ctrl);
...
private:
    ExecEnv* _exec_env;
    TPrivilegeObject::type _object = TPrivilegeObject::SYSTEM;
    TPrivilegeType::type _type = TPrivilegeType::OPERATOR;
};

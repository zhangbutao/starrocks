...
Status RedisScanner::_init_redis_scan_context(RuntimeState* state) {
    ...
    "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/util/List;Ljava/util/List;)V");
    ...
    auto scan_ctx = env->NewObject(scan_context_cls, constructor, db_name, tbl_name, redis_url, user, passwd,
                                   statement_fetch_size, column_names, column_types);
...
Status RedisScanner::_init_redis_scanner() {
    ...
    jmethodID constructor = env->GetMethodID(
    redis_scanner_cls, "<init>", "(Lcom/starrocks/redis/reader/RedisScanContext;)V");
